...
from .views import UserRetrieveUpdateView, FolderRetrieveView, FolderViewSet, OccupationListCreateView, RegisterView, LoginView , get_csrf_token, GoogleLoginView
